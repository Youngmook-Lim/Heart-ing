    ...
    [
      {
        ...
        name: "하트전달",
        content:
          "상대방에게 전달하고싶은 감정하트를 선택한 후, 전달하고 싶은 메세지가 있다면 함께 보내보세요. 전달한 마음은 24시간만 유지됩니다!",
      },
      {
        imgId: 3,
        name: "보낸하트",
        content:
          "내가 전달한 마음들을 확인해보세요! 내가 전달한 마음에 대한 반응을 알 수 있습니다. 그러나 보낸 메시지들도 24시간 뒤에 사라진다는 것을 주의하세요!",
      },
      {
        imgId: 4,
        name: "받은하트",
        content:
          "내가 받은 하트들을 볼 수 있습니다. 익명의 상대가 보낸 하트들을 눌러 마음의 메시지를 확인해보세요~! 이모티콘으로 메시지에 대한 반응도 남겨 줄 수 있습니다.",
      },
      {
        imgId: 5,
        name: "저장소",
        content:
          "받은 하트에서 24시간 뒤에도 사라지지 않았으면 하는 마음이 있다면 저장해보세요! 저장소에 마음은 영원히 간직 할 수 있습니다.",
      },
    ],
    [
      {
