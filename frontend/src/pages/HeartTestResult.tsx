        ...
        <div className="bg-hrtColorWhiteTrans border-2 border-hrtColorPink rounded-lg relative ">
          <div className="overflow-auto scrollbar-hide">
            ...
            <div>
              ...
              <div onClick={onTestHandler} className="mx-auto w-72 mt-2 modal-button text-hrtColorOutline bg-hrtColorYellow border-hrtColorNewPurple">
                <p>다시 하기</p>
              </div>
              {!isLogin ? 
                <div onClick={onHomeHandler} className="mx-auto w-72 mt-2 modal-button text-hrtColorOutline bg-hrtColorOutline900 border-hrtColorYellow">
