...
function Heartwriting() {
  ...
  return (
      ...
      {isSelected ?
        <button onClick={onSendHandler} disabled={title ? false : true} className="bg-hrtColorYellow px-8 h-16 w-48 rounded-xl border-2 border-hrtColorPink shadow-[0_4px_4px_rgba(251,139,176,1)] my-5">
